...
class MainWindow:
    ...
    def _setup_dimension_tab(self, parent, callbacks):
        ...
        ttk.Label(text_style_frame, text="Зазор до линии:").pack(anchor=tk.W, padx=5, pady=(0, 2))
        self.dimension_text_gap_entry = ttk.Entry(text_style_frame)
        self.dimension_text_gap_entry.pack(fill=tk.X, padx=5, pady=(0, 4))
