...
from logic.snap import SnapType
...
class Renderer:
    ...
    def _generate_arc_wave_coords(self, arc, sweep_limit, wave_amplitude=None):
        ...
        num_points = max(60, min(360, int(arc_length_px / 4)))
    ...
    def _discretize_arc(self, arc, num_points=None):
        ...
        if num_points is None:
            num_points = max(8, min(180, int(arc_length_px / 4)))
    ...
    def draw_snap_indicator(self, snap_point):
        ...
        snap_colors = {
            SnapType.ENDPOINT: '#FF6600',
            SnapType.MIDPOINT: '#00CC00',
            SnapType.CENTER: '#0066FF',
            SnapType.INTERSECTION: '#FF0000',
            SnapType.PERPENDICULAR: '#9900CC',
            SnapType.TANGENT: '#CC6600',
            SnapType.NEAREST: '#666666',
            SnapType.GRID: '#999999',
        }
